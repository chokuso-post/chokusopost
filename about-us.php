  ...
  <div class="row" style="margin-top: 50px;">
    ...
    <div class="col-md-offset-2 col-md-8 col-sm-12" style="padding: 10px;">
      ...
      <div class="member col-md-3 col-sm-10 col-sm-offset-1" style="padding: 10px;">
        <img src="<?php echo get_template_directory_uri(); ?>/images/imajin.jpg" alt="imajin" class="profile-picture col-xs-offset-2" style="max-width: 100%;">
      ...
      <div class="member col-md-3 col-xs-10 col-xs-offset-1" style="padding: 10px;">
        <img src="<?php echo get_template_directory_uri(); ?>/images/isogami.jpg" alt="tatsuki" class="profile-picture col-xs-offset-2">
        <h3 class="member-name">CTO<br>磯上 樹</h3>
        <p>直想便最高技術責任者のタツキです。使いやすいサービスを作れるよう頑張ります！</p>
      </div>
      <div class="member col-md-3 col-sm-10 col-sm-offset-1" style="padding: 10px;">
        <img src="<?php echo get_template_directory_uri(); ?>/images/imajin.jpg" alt="motthi" class="profile-picture col-xs-offset-2">
        <h3 class="member-name">Sales Manager <br>寺本 菜花</h3>
        <p>もってぃです。</p>
      </div>
      <div class="member col-md-3 col-sm-10 col-sm-offset-1" style="padding: 10px;">
        <img src="<?php echo get_template_directory_uri(); ?>/images/imajin.jpg" alt="okasan" class="profile-picture col-xs-offset-2">
        <h3 class="member-name">GM <br>岡田 俊樹</h3>
      </div>
      <div class="member col-md-3 col-sm-10 col-sm-offset-1" style="padding: 10px;">
        <img src="<?php echo get_template_directory_uri(); ?>/images/imajin.jpg" alt="onusan" class="profile-picture col-xs-offset-2">
        <h3 class="member-name">CMO <br>小貫 将太</h3>
      </div>
      <div class="member col-md-3 col-sm-10 col-sm-offset-1" style="padding: 10px;">
        <img src="<?php echo get_template_directory_uri(); ?>/images/imajin.jpg" alt="imajin" class="profile-picture col-xs-offset-2">
